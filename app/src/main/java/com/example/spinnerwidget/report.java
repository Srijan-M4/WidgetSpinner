...
public class report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            ...
            tvFathername.setText("Father Name ="+bundle.getString("Fathername"));
            tvGrandFathername.setText("GrandFather Name ="+bundle.getString("GrandFathername"));
            tvMothername.setText("Mother Name ="+bundle.getString("mothername"));
            tvOccupation.setText("Occupation ="+bundle.getString("occupation"));
            tvSpousename.setText("Spouse Name ="+bundle.getString("spousename"));
